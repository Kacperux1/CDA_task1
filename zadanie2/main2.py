...
plt.title('dłogość działki kielicha a szerokość działki kielicha')
plt.xlabel('dłogość dzialki kielicha')
...
plt.title('dłogość dzialki kielicha a długość płatka')
plt.xlabel('dłogość dzialki kielicha')
...
plt.title('dłogość działki kielicha a szerokość płatka')
plt.xlabel('dłogość dzialki kielicha')
...
plt.title('dłogość płatka a szerokość płatka')
plt.xlabel('dłogość płatka')
plt.ylabel('szerokość płatka')
plt.show()
