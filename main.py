...
plt.plot(init_sepals_len, regression1["a"] * init_sepals_len + regression1["b"], color='red')
...
plt.plot(init_sepals_len, regression2["a"] * init_sepals_len + regression2["b"], color='red')
...
plt.plot(init_sepals_len, regression3["a"] * init_sepals_len + regression3["b"], color='red')
...
plt.plot(init_sepals_wid, regression4["a"] * init_sepals_wid + regression4["b"], color='red')
...
plt.plot(init_sepals_wid, regression5["a"] * init_sepals_wid + regression5["b"], color='red')
...
plt.plot(init_petals_len, regression6["a"] * init_petals_len + regression6["b"], color='red')
